...
_ = "undefined" != typeof Alloy ? require("alloy/underscore")._ : require(packageDir + "underscore");

Meteor = require(packageDir + "meteor").Meteor;

var Accounts = {}, OS_ANDROID = OS_ANDROID || "android" == Ti.Platform.osname, OS_IOS = OS_IOS || !OS_ANDROID, Session = require(packageDir + "reactive-dict").ReactiveDict;
...
var init = function(options) {
    ...
    _.each(initPackages, function(key) {
        "client_convenience" == key ? require(packageDir + key)(options) : require(packageDir + key);
    });
};
