(function() {
    ...
    j.contains = j.include = function(n, t) {
        ...
        if (!t && j.isArray(n) && n[0] === +n[0] && 65535 > n.length) return Math.max.apply(Math, n);
        var e = -1 / 0, u = -1 / 0;
        ...
        if (!t && j.isArray(n) && n[0] === +n[0] && 65535 > n.length) return Math.min.apply(Math, n);
        var e = 1 / 0, u = 1 / 0;
        return A(n, function(n, i, a) {
            var o = t ? t.call(r, n, i, a) : n;
            u > o && (e = n, u = o);
    ...
    j.bind = function(n, t) {
        ...
        return function() {
            ...
            for (;arguments.length > r; ) e.push(arguments[r++]);
